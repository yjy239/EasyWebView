...
public class BridgeUtil {
	...
	public static void webViewLoadJs(IWebView view, String url){
		...
		view.load("javascript:" + js,null,null);
	}

    public static void webViewLoadLocalJs(Context context, IWebView view, String path){
        String jsContent = assetFile2Str(context, path);
        view.load("javascript:" + jsContent,null,null);
    }
